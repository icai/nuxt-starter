<template>
  <div class="app-layout-content-tab">
    <el-tabs v-model="activeSessionPath" :closable="sessions.length > 1" @tab-click="gotoTabView" @tab-remove="delTabView">
      <el-tab-pane v-for="item in sessions" :key="item.path" :label="item.title" :name="item.path" />
    </el-tabs>
    <el-dropdown class="app-layout-content-tab-menu" trigger="click" @command="handleTabMenu">
