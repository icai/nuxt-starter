<template>
  <NuxtLayout name="admin-layout">
    <div class="n-result n-result-404">
      <div class="n-result-icon n-result-image">
      ...
      <div class="n-result-title">404</div>
      <div class="n-result-subtitle">Sorry, the page you visited does not exist. please check your URL. <br/> {{ redirectedFrom }}</div>
      <div class="n-result-extra">
        <el-button type="primary"><span>Back Home</span></el-button>
      </div>
    </div>
  </NuxtLayout>
</template>
...
redirectedFrom.value = route.query?.from  || route?.redirectedFrom?.fullPath
watch(() => route.query?.from, (val) => {
  redirectedFrom.value = val
})
</script>
...
.n-result-success .n-result-icon>.anticon {
  color: #52c41a
}

.n-result-error .n-result-icon>.anticon {
  color: #f5222d
}

.n-result-info .n-result-icon>.anticon {
  color: #1890ff
}

.n-result-warning .n-result-icon>.anticon {
  color: #faad14
}
