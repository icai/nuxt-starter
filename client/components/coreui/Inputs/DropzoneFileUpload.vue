  ...
  <div class="dropzone mb-3 dz-clickable" :class="[multiple ? 'dropzone-multiple' : 'dropzone-single']">
    <div class="fallback">
      <div class="custom-file">
        <input id="projectCoverUploads" type="file" class="custom-file-input" :multiple="multiple" />
        <label class="custom-file-label" for="projectCoverUploads">Choose file</label>
      </div>
    </div>
    <div v-if="!multiple" ref="previewSingle" class="dz-preview dz-preview-single" :class="previewClasses">
      <div class="dz-preview-cover">
        <img class="dz-preview-img" data-dz-thumbnail />
      </div>
    </div>
    <ul v-else ref="previewMultiple" class="dz-preview dz-preview-multiple list-group list-group-lg list-group-flush" :class="previewClasses">
